"""13_3mm_reg_L1_L2_tile: 3MM (3-matrix multiplication) proxy with register + L1 + L2 tiling.
...
if __name__ == "__main__":
    A, B, C = _make_args()
    rec = kernel_3mm_reg_L1_L2_tile.measure(A, B, C)
    rec["verified"] = kernel_3mm_reg_L1_L2_tile.verify(A, B, np.zeros_like(C))
