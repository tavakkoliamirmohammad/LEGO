"""Measure 22_jacobi2d_brick: simplified jacobi-2d with brick layout pattern."""
import json
import sys
import time
import numpy as np
...
def main():
    ...
    try:
        t_scalar_jit = kernel_cpu_dsl.bench_self_timed(A, B_sc, n_iters=1000, n_warmup=100, target='scalar')
    except Exception:
        pass
    ...
    notes = ""
    try:
        t_vec_jit = kernel_cpu_dsl.bench_self_timed(A, B_v, n_iters=1000, n_warmup=100, target='x86')
    ...
    print(json.dumps({
        ...
        "verdict": verdict,
        "notes": notes or "simplified jacobi2d brick: flat 1D tiling with 4-neighbor offsets",
    }))
