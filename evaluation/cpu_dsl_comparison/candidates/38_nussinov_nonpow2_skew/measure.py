"""Measure 38_nussinov_nonpow2_skew.

CASTLE candidate 31. Layout class: Skew+non-pow2.
Prior verdicts: AMD MIXED, Intel MIXED.

This candidate models a stride-2 access pattern characteristic of Skew+non-pow2.
...
def main():
    ...
    print(json.dumps({
        "name": "38_nussinov_nonpow2_skew",
        "N": N_BENCH,
        "layout_class": "Skew+non-pow2",
        "prior_verdict": "MIXED",
