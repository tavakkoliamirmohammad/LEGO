...
void legoRegisterPasses() {
  ...
  mlir::lego::registerLegoVectorizeArgminPass();
  mlir::lego::registerLegoVectorizeScanPass();
  mlir::lego::registerLegoVectorizeFilteredReducePass();
  mlir::lego::registerLegoVectorizeRLEPass();
