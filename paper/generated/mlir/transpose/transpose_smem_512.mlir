module {
  func.func @main() {
    ...
    affine.for %arg0 = 0 to 125 {
      ...
      %1 = gpu.memcpy async [%asyncToken_1] %memref, %alloc : memref<262144xf32>, memref<262144xf32>
      gpu.launch blocks(%arg1, %arg2, %arg3) in (%arg7 = %c256, %arg8 = %c1, %arg9 = %c1) threads(%arg4, %arg5, %arg6) in (%arg10 = %c256, %arg11 = %c1, %arg12 = %c1) workgroup(%arg13 : memref<1024xf32, 3>) {
        ...
        %38 = arith.muli %37, %c512_i32 : i32
        %39 = arith.remui %4, %c16_i32 : i32
        %40 = arith.muli %39, %c16384_i32 : i32
        ...
        affine.for %arg14 = 0 to 4 {
          ...
          %48 = arith.muli %42, %c4096_i32 : i32
          %49 = arith.addi %41, %48 : i32
          %50 = arith.addi %49, %40 : i32
          %51 = arith.addi %50, %27 : i32
          %52 = arith.index_cast %51 : i32 to index
          memref.store %47, %memref_0[%52] : memref<262144xf32>
        }
        gpu.terminator
      }
