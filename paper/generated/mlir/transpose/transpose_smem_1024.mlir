  ...
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %c125 step %c1 {
      ...
      gpu.launch blocks(%arg1, %arg2, %arg3) in (%arg7 = %c1024, %arg8 = %c1, %arg9 = %c1) threads(%arg4, %arg5, %arg6) in (%arg10 = %c256, %arg11 = %c1, %arg12 = %c1) workgroup(%arg13 : memref<1024xf32, 3>) {
        ...
        %4 = arith.divui %block_id_x, %c32 : index
        %5 = arith.remui %block_id_x, %c32 : index
        ...
        scf.for %arg14 = %c0 to %c4 step %c1 {
          ...
          %14 = arith.muli %11, %c1024 : index
          %15 = arith.addi %13, %14 : index
          %16 = memref.load %memref[%15] : memref<1048576xf32>
        ...
        scf.for %arg14 = %c0 to %c4 step %c1 {
          ...
          %17 = arith.muli %14, %c1024 : index
          %18 = arith.addi %16, %17 : index
          memref.store %12, %memref_0[%18] : memref<1048576xf32>
        }
        gpu.terminator
      }
