  ...
  func.func @main() {
    ...
    affine.for %arg0 = 0 to 125 {
      ...
      gpu.launch blocks(%arg1, %arg2, %arg3) in (%arg7 = %c16384, %arg8 = %c1, %arg9 = %c1) threads(%arg4, %arg5, %arg6) in (%arg10 = %c256, %arg11 = %c1, %arg12 = %c1) {
        ...
        %27 = arith.muli %10, %c4096_i32 : i32
        %28 = arith.muli %6, %c131072_i32 : i32
        affine.for %arg13 = 0 to 4 {
          %29 = arith.index_cast %arg13 : index to i32
          %30 = arith.muli %29, %c32768_i32 : i32
          %31 = arith.addi %25, %30 : i32
          %32 = arith.addi %31, %24 : i32
          %33 = arith.addi %32, %10 : i32
          %34 = arith.index_cast %33 : i32 to index
          %35 = memref.load %memref_0[%34] : memref<16777216xf32>
          ...
          memref.store %35, %memref[%41] : memref<16777216xf32>
        }
        gpu.terminator
      }
