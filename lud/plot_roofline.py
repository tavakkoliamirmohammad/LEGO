...
FNPAT = re.compile(r"ncu-run-(lego|orig)-(\d+)-s(\d+)\.roofline\.csv$")
...
def main():
    ...
    ap.add_argument("--include", type=str, nargs="+", default=["lego-2", "lego-4", "lego-8", "orig-32"],
                    help="Series keys to include (derived from filenames). Example: lego-2 lego-4 lego-8 orig-32")
    ap.add_argument("--out", type=str,
                    default="lud_roofline.png", help="Output PNG path.")
