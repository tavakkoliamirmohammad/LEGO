module {
  func.func @main() {
    ...
    affine.for %arg0 = 0 to 125 {
      %0 = gpu.wait async
      %memref, %asyncToken = gpu.alloc async [%0] () : memref<65536xf32>
      %alloc = memref.alloc() : memref<65536xf32>
      %memref_0, %asyncToken_1 = gpu.alloc async [%asyncToken] () : memref<65536xf32>
      affine.for %arg1 = 0 to 65536 {
        %4 = arith.index_cast %arg1 : index to i32
        %5 = arith.sitofp %4 : i32 to f32
        memref.store %5, %alloc[%arg1] : memref<65536xf32>
      }
      %1 = gpu.memcpy async [%asyncToken_1] %memref, %alloc : memref<65536xf32>, memref<65536xf32>
      gpu.launch blocks(%arg1, %arg2, %arg3) in (%arg7 = %c64, %arg8 = %c1, %arg9 = %c1) threads(%arg4, %arg5, %arg6) in (%arg10 = %c256, %arg11 = %c1, %arg12 = %c1) workgroup(%arg13 : memref<1024xf32, 3>) {
        memref.assume_alignment %memref, 128 : memref<65536xf32>
        memref.assume_alignment %memref_0, 128 : memref<65536xf32>
        %block_id_x = gpu.block_id  x
        %4 = arith.index_cast %block_id_x : index to i32
        %thread_id_x = gpu.thread_id  x
        %5 = arith.index_cast %thread_id_x : index to i32
        %6 = arith.remui %4, %c8_i32 : i32
        ...
        %38 = arith.muli %37, %c256_i32 : i32
        %39 = arith.remui %4, %c8_i32 : i32
        %40 = arith.muli %39, %c8192_i32 : i32
        ...
        affine.for %arg14 = 0 to 4 {
          ...
          %48 = arith.muli %42, %c2048_i32 : i32
          %49 = arith.addi %41, %48 : i32
          %50 = arith.addi %49, %40 : i32
          %51 = arith.addi %50, %27 : i32
          %52 = arith.index_cast %51 : i32 to index
          memref.store %47, %memref_0[%52] : memref<65536xf32>
        }
        gpu.terminator
      }
      %2 = gpu.dealloc async [%1] %memref : memref<65536xf32>
      %3 = gpu.dealloc async [%2] %memref_0 : memref<65536xf32>
    }
    return
  }
}
